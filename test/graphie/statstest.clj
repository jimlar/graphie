...
(fact "A new value for another second starts new value list and summarizes the previous second"
  ...
  => {:request_time {:in [640] :second 2 :secs [{:avg 388, :sum 776, :max 456, :min 320, :samples 2, :second 0}]}})

(fact "A new value for a third  second starts adds to the seconds list"
  (merge-message
    {:request_time {:in [640] :second 2 :secs [{:avg 388, :sum 776, :max 456, :min 320, :samples 2, :second 0}]}}
    {:name "request_time" :value 720 :type "v", :time 3000})
  => {:request_time {:in [720] :second 3 :secs [{:avg 388, :sum 776, :max 456, :min 320, :samples 2, :second 0}
                                                {:avg 640, :sum 640, :max 640, :min 640, :samples 1, :second 2}]}})
